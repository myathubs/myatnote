...
st.set_page_config(page_title="🧠 Myat Note", page_icon="🧠")

st.title("🧠 Myat Note")
st.markdown("Convert YouTube videos into smart notes with Gemini AI, in English or Burmese. 🇲🇲")
...
# Footer
st.markdown("---")
st.markdown("Made with ❤️ by Myat Min Ko | Powered by Myat Note ✨")
